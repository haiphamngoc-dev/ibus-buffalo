...
- **Hỗ trợ các kiểu gõ phổ biến**: Hỗ trợ các kiểu gõ **Telex**, **Simple Telex** và **VNI**.
...
`target/debian/ibus-buffalo_0.2.0_amd64.deb`
...
```bash
sudo dpkg -i target/debian/ibus-buffalo_0.2.0_amd64.deb
```
